...
duration_ptiles <- unique(approx_ecdf(model_data, duration)(seq(0.05, 0.95, 0.1)))
attage_ptiles <- unique(approx_ecdf(model_data, attained_age)(c(0.025, seq(0.1, 0.9, 0.1), 0.975)))
observation_time_ptiles <- unique(approx_ecdf(model_data, observation_time)(seq(0.25, 0.75, by=0.25)))
